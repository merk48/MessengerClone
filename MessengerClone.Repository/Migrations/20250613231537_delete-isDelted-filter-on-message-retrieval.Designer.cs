...
namespace MessengerClone.Repository.Migrations
{
    ...
    [Migration("20250613231537_delete-isDelted-filter-on-message-retrieval")]
    partial class deleteisDeltedfilteronmessageretrieval
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("LastMessageSnapshot", "LastMessage", b1 =>
                        {
                            ...
                            b1.Property<string>("SenderUserame")
                                .IsRequired()
                                .HasMaxLength(100)
                                .HasColumnType("nvarchar(100)")
